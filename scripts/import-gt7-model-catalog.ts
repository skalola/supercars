...
function tunerSupplementalRows(): CatalogRow[] {
  const secondarySource = "Secondary tuner references: CarCovers, MotorTrend/Super Street, HiConsumption, JEGS";
  const rows: Array<[string, string, number | null, string?]> = [
    ...
    ["BMW", "3 Series E36", 1999],
    ["BMW", "3 Series E46", 2005],
    ["BMW", "M3 E36", 1999],
    ["BMW", "M3 E46", 2006],
    ["Chevrolet", "Corvette C5", 2004],
    ["Dodge", "Neon SRT-4", 2005],
    ["Ford", "Mustang Fox Body", 1993],
    ...
    ["Nissan", "350Z", 2008],
    ["Nissan", "370Z", 2020],
    ["Nissan", "Sentra SE-R Spec V", 2006],
  ...
  return rows.map(([make, model, year, source]) => ({
    make,
    model,
    year,
