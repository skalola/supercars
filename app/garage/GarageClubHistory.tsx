        ...
        <div className="garage-club-grid">
          {clubs.map((club) => (
            <Link key={club.id} href={club.href} className="garage-club-card">
              <div className="garage-club-card-header">
                <div className="garage-club-mark" aria-hidden="true">
              ...
              <div className="garage-club-card-stats">
                ...
                <span><strong>{club.modelCount}</strong> models</span>
                <span><strong>{club.meetCount}</strong> meets</span>
              </div>
